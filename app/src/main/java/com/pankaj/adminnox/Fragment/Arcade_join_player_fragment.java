 ...
 */
public class Arcade_join_player_fragment extends Fragment {
    ...
    public Arcade_join_player_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_arcade_join_player_fragment, container, false);
        databaseReference = FirebaseDatabase.getInstance().getReference("Arcade_join_player").child("EntryComplete_player");
        ...
        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Query applesQuery = ref.child("Arcade_join_player").child("EntryComplete_player");

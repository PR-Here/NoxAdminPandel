 ...
 */
public class Classic_join_player_fragment extends Fragment {
    ...
    public Classic_join_player_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_classic_join_player_fragment, container, false);

        databaseReference = FirebaseDatabase.getInstance().getReference("Classic_join_player").child("EntryComplete_player");
        ...
        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Query applesQuery = ref.child("Classic_join_player").child("EntryComplete_player");

 ...
 */
public class ClassicSolo_join_player_fragment extends Fragment {
    ...
    public ClassicSolo_join_player_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_classic_solo_join_player_fragment, container, false);

        databaseReference = FirebaseDatabase.getInstance().getReference("ClassicSolo_join_player").child("EntryComplete_player");
        ...
        alertDialogBuilder.setMessage("Do you want to Delete all Entry?");        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Query applesQuery = ref.child("ClassicSolo_join_player").child("EntryComplete_player");

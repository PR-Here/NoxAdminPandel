...
import com.pankaj.adminnox.JavaClass.Classic_Solo;
import com.pankaj.adminnox.R;

public class LiteSolo_Activity extends AppCompatActivity {

    EditText matchno, date, time, registration, roomid, password, prizepool, perkill, entryfee, type,
            mode, map, information, disabled, paidentry, winner, rank1, rank2, rank3, upiid;
    Button update;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_solo_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("SoloMatch");
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            String st_registration = dataSnapshot.child("registration").getValue(String.class);
                            String st_roomid = dataSnapshot.child("id").getValue(String.class);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    final Classic_Solo s1 = new Classic_Solo(st_matchno, st_date, st_time, st_registration, st_roomid
                            , st_password, st_prizepool, st_perkill, st_entryfee, st_type, st_mode, st_map, st_info, st_disabled,
                            st_paidentry, st_winner, st_rank1, st_rank2, st_rank3, st_upiid);
                    databaseReference.setValue(s1);


                    Toast.makeText(LiteSolo_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(LiteSolo_Activity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();

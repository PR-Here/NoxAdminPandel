...
public class ClassicSolo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_solo_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("classicSolo")
                .child("SoloMatch");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(ClassicSolo_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) ClassicSolo_Activity.this).isFinishing()) {

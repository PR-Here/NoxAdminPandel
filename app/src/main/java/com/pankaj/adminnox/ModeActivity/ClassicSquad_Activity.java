...
public class ClassicSquad_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_squad_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("classicmode")
                .child("firstactivity");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(ClassicSquad_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) ClassicSquad_Activity.this).isFinishing()) {

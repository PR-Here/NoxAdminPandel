...
public class ClassicArcade_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_arcade_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("arcademode")
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(ClassicArcade_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) ClassicArcade_Activity.this).isFinishing()) {

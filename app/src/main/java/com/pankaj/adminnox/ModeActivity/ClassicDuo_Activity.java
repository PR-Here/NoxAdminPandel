...
public class ClassicDuo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_duo_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("classicDuo")
                .child("DuoActivity");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    final Classic_duo s1 = new Classic_duo(st_matchno, st_date, st_time, st_registration, st_roomid
                            , st_password, st_prizepool, st_perkill, st_entryfee,st_type,st_mode,st_map,st_info,st_disabled,
                            st_paidentry,st_winner,st_rank1,st_rank2,st_rank3,st_rank4,st_rank5,st_upiid);
                    databaseReference.setValue(s1);


                    try {

                        Toast.makeText(ClassicDuo_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) ClassicDuo_Activity.this).isFinishing()) {

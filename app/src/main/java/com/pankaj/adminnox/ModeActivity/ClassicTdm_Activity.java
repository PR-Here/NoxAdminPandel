...
public class ClassicTdm_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic_tdm_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("deathmatch")
                .child("fouractivity");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(ClassicTdm_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) ClassicTdm_Activity.this).isFinishing()) {

...
public class LiteDuo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_duo_);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("freefire")
                .child("DuoActivity");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(LiteDuo_Activity.this, "Data Update", Toast.LENGTH_SHORT).show();
                    } catch (NullPointerException nullPointerException) {
                        System.out.println("Catch the NullPointerException in FragmentPagerAdapter.finishUpdate");
                    }


                    if (!((Activity) LiteDuo_Activity.this).isFinishing()) {
